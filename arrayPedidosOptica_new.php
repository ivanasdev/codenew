...
while( $arrayQuery0 = mssql_fetch_array($rquery0) ){ 
	...
	$listado .= '
	<tr>
	<td><center>'.$folio.'</center></td>
	<td><center>'.utf8_encode(trim($Nombre)).'</center></td>
	<td><center>'.$fecha_compra.'</center></td>
	<td><center>'.utf8_encode(trim($Sucursal)).'</center></td>	
	<td><center>'.$abono.'</center></td>
	<td><center>'.$total.'</center></td>
	<td><center>'.$saldo.'</center></td>
	<td><center>'.$Producto.'</center></td>
	<td><center>'.utf8_encode(trim($st_StatusPedidoOptica)).'</center></td>
	<td><center>'.$ticket.'</center></td>
	<td><center>'.utf8_encode(trim($UsuarioCaja)).'</center></td>
	<td><center>'.$imprimeFolio.'</center></td>
	<td><center>'.$ingresarPedido.'</center></td>
	<td><center>'.$enviarLaboratorio.'</center></td>
	<td><center>'.$recibirEnSucursal.'</center></td>
	<td><center>'.$entregarAcliente.'</center></td>
